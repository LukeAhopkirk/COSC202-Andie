...
public class SoftBlur implements ImageOperation, java.io.Serializable{
    ...
    */
     ...
     * 
     * <p>
     * Blurs the image slightly by averaging the values of each pixel with the values of its surrounding pixels. 
     * The weights in the kernel are higher for the pixels that are closer to the central pixel, 
     * so those pixels have a greater influence on the output value. 
     * This results in the image being slightly blurred, but not so much that the details are completely lost.
     * </p>
     * 
