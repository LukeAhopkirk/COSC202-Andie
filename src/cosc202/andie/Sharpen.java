 ...
 * It works by increasing the contrast between neighboring pixels, making edges appear sharper and more defined.
 * </p>
 * 
*/
public class Sharpen implements ImageOperation, java.io.Serializable{
    ...
    */
     ...
     * The kernel used in this code places a higher weight on the central 
