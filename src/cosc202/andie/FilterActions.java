...
public class FilterActions {
    ...
    public class GaussianAction extends ImageAction {
         ...
         * <p>
         * This method is called whenever the MeanFilterAction is triggered.
         * It prompts the user for a filter radius, then applys an appropriately sized {@link GaussianB}.
         * </p>
         * 
         * @param e The event triggering this callback.
         */
    ...
    */
    public class SoftBlurAction extends ImageAction {
         ...
         * It prompts the user for a filter radius, then applys an appropriately sized {@link SoftBlur}.
         * </p>
         * 
         * @param e The event triggering this callback.
         */
    ...
    public class SharpenAction extends ImageAction {
         ...
         * <p>
         * This method is called whenever the MeanFilterAction is triggered.
         * It prompts the user for a filter radius, then applys an appropriately sized {@link Sharpen}.
         * </p>
         * 
         * @param e The event triggering this callback.
         */
